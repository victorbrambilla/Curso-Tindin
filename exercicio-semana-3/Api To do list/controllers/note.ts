...
const get = async (req: Request<any>, res: Response<any>) => {
    try {
        ...
        const noteFound = await note.get(id, userId)
        res.json(noteFound)
    } catch (err: any) {
        return error(res, err)
    }
...
const create = async (req: Request<any>, res: Response<any>) => {
    try {
        ...
        const noteCreated = await note.create({ title, description, status }, userId)
...
const update = async (req: Request<any>, res: Response<any>) => {
    try {
        ...
        const noteUpdated = await note.update({ id, title, description, status }, userId)
